...
- The footer keeps the daily quote and visible version number. Desktop uses a lightweight bottom-left quote marker; mobile uses a centered compact glass band inside the bottom safe area.
