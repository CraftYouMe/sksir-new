...
function renderQuickLaunchCustomList() {
    ...
    items.forEach(function (item) {
        ...
        if (window.SksirIconCache && typeof window.SksirIconCache.load === "function") {
            window.SksirIconCache.load(icon, item.icon);
        } else {
            icon.src = item.icon;
        }
        icon.alt = "";
...
var bg_img_preinstall = {
    "type": "1",
    "path": window.sksirDefaultWallpaper || "https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background1.webp",
};
var bgImgStorageKey = "sksir-bg-img";

var bg_img_pictures = window.sksirWallpaperPictures || [
    'https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background1.webp',
    'https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background-image2.webp',
    'https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background-image3.webp',
    'https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background-image4.webp',
    'https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background-image5.webp',
    'https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/icon/background-image6.webp'
];

var bgImgResponsiveBase = window.sksirWallpaperAssetBase || "https://yuanone-blog-picture.oss-cn-beijing.aliyuncs.com/sksir/2026.08.03.12/wallpaper/responsive/";
    ...
    switch (bg_img["type"]) {
        case "2":
            return bg_img["path"] &&
                ...
                ? bg_img["path"]
                : (window.sksirApiUrl ? window.sksirApiUrl("/api/bing") : "/api/bing");
        case "5":
            return bg_img["path"] || "";
        case "1":
        default:
...
function setBackgroundFocusEffect(active) {
    ...
    if (document.documentElement.hasAttribute("data-sksir-extension") && document.body) {
        document.body.classList.toggle("sksir-background-focus", !!active);
    }
    $('#bg').css({
