...
- 收藏中心采用悬浮玻璃工具栏，搜索、测速、设置和关闭操作集中在同一行；桌面端卡片一行最多显示 5 个
- 收藏中心可在“设置 → 导航”选择显示 1 至 6 行卡片，未设置或设置损坏时默认显示 6 行；内容超出面板后可在内容区滚动，配置保存在当前浏览器
- `Esc` 可快速关闭搜索、书签和设置层
...
- 设置中心使用与收藏中心一致的悬浮一级分类工具栏，内容改为单一连续滚动区；移动端分类可横向滚动
...
- 设置中心样式与控制器在首屏流程后预热，壁纸管理脚本仅在使用对应功能时加载，不阻塞首页首屏
...
├── js/bookmarks.js           # 收藏中心搜索、筛选、工具栏与面板交互
...
- 在“设置 → 导航”中可以选择收藏中心显示 1 至 6 行；该值保存在 `sksir-bookmark-visible-rows`，未设置或设置损坏时默认显示 6 行，内容超出面板后可在内容区滚动。
