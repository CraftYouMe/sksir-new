window.SKSIR_CHANGELOG = {
  "generatedAt": "2026-07-28T17:18:01.378Z",
  "source": "git",
  "entries": [
    {
      "hash": "d58998a",
      "date": "2026-07-29",
      "summary": "添加发布说明，并实现变更日志生成器",
      "details": [
        "改善页面性能与项目维护的交互细节",
        "新增版本发布说明文档，详细介绍了 2026.07.29.1 版本的主要变更、性能改进和验证步骤。",
        "实现了一个从 Git 提交历史生成变更日志的脚本，将变更按“fix”“new”“improve”“optimize”等标签进行分类。",
        "增强了变更日志生成流程，能够清理提交信息并将其翻译为简洁易懂的中文摘要。",
        "增加了对生成的变更日志结构进行校验并确保数据完整性的功能。",
      ],
      "tags": [
        "new",
        "improve",
