window.SKSIR_CHANGELOG = {
  "generatedAt": "2026-07-29T11:36:26.107Z",
  "source": "git",
  "entries": [
    {
      "hash": "2a58d4a",
    ...
    },
    {
      "hash": "055b10d",
      "date": "2026-07-29",
      "summary": "添加发布说明，并实现更新日志生成器",
      "details": [
        "新增版本 2026.07.29.1 的发布说明文档，详细介绍主要改动、性能优化以及验证步骤。", 
        "实现了一个脚本，可根据 Git 提交历史自动生成更新日志，并按照标签分类变更内容，例如「修复（fix）」、「新增（new）」、「改进（improve）」和「优化（optimize）」。",
        "增强了更新日志生成流程，可以清理并翻译提交信息，将其转换为用户更容易理解的中文摘要。",
        "新增功能用于验证生成的更新日志结构，并确保数据完整性。"
      ],
      "tags": [
        "fix",
        "new",
